...
class _TransactionModalState extends State<TransactionModal> {
  ...
  void _setupStreams() {
    SupabaseService().streamTransactionsByInvoice(widget.invoice.id).listen((transactions) {
      setState(() {
  ...
  Future<void> _loadTransactions() async {
    try {
      final transactions = await SupabaseService().getTransactionsByInvoice(widget.invoice.id);
      setState(() {
        _transactions = transactions;
      });
    } catch (e) {
  ...
  Future<void> _addTransaction() async {
    ...
    try {
      ...
      final savedTransaction = await SupabaseService().createTransaction(transaction);
  ...
  Future<void> _cancelTransaction(Transaction transaction) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Are you sure you want to cancel this payment of ${DateFormatter.formatCurrency(transaction.amount)}?'),
        actions: [
          TextButton(
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: !_showHistory ? Theme.of(context).primaryColor : Colors.grey[300],
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                leading: Icon(
                                  transaction.isActive ? Icons.check_circle : Icons.cancel,
                                  color: transaction.isActive ? Colors.green : Colors.red,
                                ),
                                title: Text(
                                ...
                                subtitle: Text(
                                  DateFormatter.formatDisplayDate(transaction.paymentDate),
                                ),
