...
class _TransactionModalState extends State<TransactionModal> {
  ...
  Future<void> _markAsPaid() async {
    ...
    try {
      final fullAmount = widget.invoice.remainingAmount;
      ...
      final updatedInvoice = widget.invoice.copyWith(
        paidAmount: widget.invoice.amount,
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Payment of ${DateFormatter.formatCurrency(fullAmount)} recorded successfully!',
            ),
                      ...
                      if (widget.invoice.remainingAmount > 0) ...[
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            label: Text(
                              'PAID (${DateFormatter.formatCurrency(widget.invoice.remainingAmount)})',
